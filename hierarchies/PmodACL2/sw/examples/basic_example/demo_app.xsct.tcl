...
namespace eval PmodACL2_basic_example {
    variable script_dir
    ...
    proc init {} {
        ...
        set PmodACL2_basic_example::script_dir [file normalize [file dirname $script]]
    }
    ...
    proc create_app {app_name sysproj_name domain_name platform_name} {
        ...
        set app_sources [file join ${PmodACL2_basic_example::script_dir} sources]
        set drivers [file join [file dirname [file dirname ${PmodACL2_basic_example::script_dir}]] sources]
