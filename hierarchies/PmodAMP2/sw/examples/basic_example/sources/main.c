...
#include "xparameters.h"
   ...
   #define INTC_TMR_INTERRUPT_ID XPAR_FABRIC_PMODAMP2_0_AXI_TIMER_0_INTERRUPT_INTR
#endif

#define PWM_BASEADDR   XPAR_PMODAMP2_0_PWM_0_PWM_AXI_BASEADDR
#define GPIO_BASEADDR  XPAR_PMODAMP2_0_AXI_GPIO_0_BASEADDR
#define TIMER_BASEADDR XPAR_PMODAMP2_0_AXI_TIMER_0_BASEADDR
