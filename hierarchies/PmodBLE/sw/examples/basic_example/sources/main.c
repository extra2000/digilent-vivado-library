...
#define BLE_UART_AXI_CLOCK_FREQ XPAR_PMODBLE_0_AXI_UART16550_0_CLOCK_FREQ_HZ
#endif
...
void DemoInitialize()
{
    ...
    BLE_Begin (
        &myDevice,
		XPAR_PMODBLE_0_AXI_GPIO_0_BASEADDR,
		XPAR_PMODBLE_0_AXI_UART16550_0_BASEADDR,
