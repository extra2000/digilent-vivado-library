...
namespace eval PmodCAN_RX {
    ...
    proc init {} {
        ...
        set PmodCAN_RX::script_dir [file normalize [file dirname $script]]
    }
    ...
    proc create_app {app_name sysproj_name domain_name platform_name} {
        ...
        set app_sources [file join ${PmodCAN_RX::script_dir} sources]
        set drivers [file join [file dirname [file dirname ${PmodCAN_RX::script_dir}]] sources]
