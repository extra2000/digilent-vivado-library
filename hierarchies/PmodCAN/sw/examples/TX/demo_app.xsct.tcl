...
namespace eval PmodCAN_TX {
    ...
    proc init {} {
        ...
        set PmodCAN_TX::script_dir [file normalize [file dirname $script]]
    }
    ...
    proc create_app {app_name sysproj_name domain_name platform_name} {
        ...
        set app_sources [file join ${PmodCAN_TX::script_dir} sources]
        set drivers [file join [file dirname [file dirname ${PmodCAN_TX::script_dir}]] sources]
