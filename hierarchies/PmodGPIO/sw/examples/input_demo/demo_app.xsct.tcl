...
namespace eval PmodGPIO_input_demo {
    variable script_dir
    ...
    proc init {} {
        ...
        set PmodGPIO_input_demo::script_dir [file normalize [file dirname $script]]
    }
    ...
    proc create_app {app_name sysproj_name domain_name platform_name} {
        ...
        set app_sources [file join ${PmodGPIO_input_demo::script_dir} sources]
        set drivers [file join [file dirname [file dirname ${PmodGPIO_input_demo::script_dir}]] sources]
