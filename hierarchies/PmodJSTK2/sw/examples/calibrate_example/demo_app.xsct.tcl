...
namespace eval PmodJSTK2_calibrate_example {
    variable script_dir
    ...
    proc init {} {
        ...
        set PmodJSTK2_calibrate_example::script_dir [file normalize [file dirname $script]]
    }
    ...
    proc create_app {app_name sysproj_name domain_name platform_name} {
        ...
        set app_sources [file join ${PmodJSTK2_calibrate_example::script_dir} sources]
        set drivers [file join [file dirname [file dirname ${PmodJSTK2_calibrate_example::script_dir}]] sources]
...
PmodJSTK2_calibrate_example::init