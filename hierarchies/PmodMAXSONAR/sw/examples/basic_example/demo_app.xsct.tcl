...
namespace eval PmodMAXSONAR_basic_example {
    variable script_dir
    ...
    proc init {} {
        ...
        set PmodMAXSONAR_basic_example::script_dir [file normalize [file dirname $script]]
    }
    ...
    proc create_app {app_name sysproj_name domain_name platform_name} {
        ...
        set app_sources [file join ${PmodMAXSONAR_basic_example::script_dir} sources]
        set drivers [file join [file dirname [file dirname ${PmodMAXSONAR_basic_example::script_dir}]] sources]
...
PmodMAXSONAR_basic_example::init