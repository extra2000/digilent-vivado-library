...
void PmodToF_Initialize()
{
	...
	ISL29501_begin(&myToFDevice, XPAR_PMODTOF_0_AXI_IIC_0_BASEADDR,ISL29501_CHIP_ADDRESS);
    EPROM_begin(&myEPROMDevice, XPAR_PMODTOF_0_AXI_IIC_0_BASEADDR, EPROM_CHIP_ADDRESS);
    XGpio_Initialize(&gpio, XPAR_PMODTOF_0_AXI_GPIO_0_DEVICE_ID); //initialize input XGpio variable
