...
architecture behav of ZmodScopeConfig is 
    ...
    signal ConfigAxil : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal EnableAcquisition_1_data_reg : STD_LOGIC_VECTOR (0 downto 0) := "0";
    signal EnableAcquisition_1_vld_reg : STD_LOGIC := '0';
    signal EnableAcquisition_1_vld_in : STD_LOGIC;
    signal EnableAcquisition_1_ack_in : STD_LOGIC;
    signal Reset_1_data_reg : STD_LOGIC_VECTOR (0 downto 0) := "0";
    signal Reset_1_vld_reg : STD_LOGIC := '0';
    signal Reset_1_vld_in : STD_LOGIC;
    signal Reset_1_ack_in : STD_LOGIC;
    signal trunc_ln674_fu_332_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    EnableAcquisition_1_vld_reg_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        end if;
    end process;

    Reset_1_vld_reg_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = Ch1Coupling_1_vld_in) and (ap_const_logic_1 = Ch1Coupling_1_vld_reg)) or (not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_0 = Ch1Coupling_1_vld_reg) and (ap_const_logic_1 = Ch1Coupling_1_vld_in)))) then
                Ch1Coupling_1_data_reg <= ConfigAxil(2 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = Ch1Gain_1_vld_in) and (ap_const_logic_1 = Ch1Gain_1_vld_reg)) or (not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_0 = Ch1Gain_1_vld_reg) and (ap_const_logic_1 = Ch1Gain_1_vld_in)))) then
                Ch1Gain_1_data_reg <= trunc_ln674_fu_332_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = Ch2Coupling_1_vld_in) and (ap_const_logic_1 = Ch2Coupling_1_vld_reg)) or (not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_0 = Ch2Coupling_1_vld_reg) and (ap_const_logic_1 = Ch2Coupling_1_vld_in)))) then
                Ch2Coupling_1_data_reg <= ConfigAxil(3 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = Ch2Gain_1_vld_in) and (ap_const_logic_1 = Ch2Gain_1_vld_reg)) or (not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_0 = Ch2Gain_1_vld_reg) and (ap_const_logic_1 = Ch2Gain_1_vld_in)))) then
                Ch2Gain_1_data_reg <= ConfigAxil(1 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = EnableAcquisition_1_vld_in) and (ap_const_logic_1 = EnableAcquisition_1_vld_reg)) or (not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_0 = EnableAcquisition_1_vld_reg) and (ap_const_logic_1 = EnableAcquisition_1_vld_in)))) then
                EnableAcquisition_1_data_reg <= ConfigAxil(5 downto 5);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = Reset_1_vld_in) and (ap_const_logic_1 = Reset_1_vld_reg)) or (not(((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) and (ap_const_logic_0 = Reset_1_vld_reg) and (ap_const_logic_1 = Reset_1_vld_in)))) then
                Reset_1_data_reg <= ConfigAxil(6 downto 6);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((not(((ap_const_logic_0 = Ch1LgMultCoef_1_ack_in) or (ap_const_logic_0 = Ch1HgMultCoef_1_ack_in) or (ap_const_logic_0 = Reset_1_ack_in) or (ap_const_logic_0 = EnableAcquisition_1_ack_in) or (ap_const_logic_0 = TestMode_1_ack_in) or (ap_const_logic_0 = Ch2Coupling_1_ack_in) or (ap_const_logic_0 = Ch1Coupling_1_ack_in) or (ap_const_logic_0 = Ch2Gain_1_ack_in) or (ap_const_logic_0 = Ch1Gain_1_ack_in) or (ap_const_logic_0 = Ch2HgAddCoef_1_ack_in) or (ap_const_logic_0 = Ch2LgAddCoef_1_ack_in) or (ap_const_logic_0 = Ch2LgMultCoef_1_ack_in) or (ap_const_logic_0 = Ch2HgMultCoef_1_ack_in) or (ap_const_logic_0 = Ch1HgAddCoef_1_ack_in) or (ap_const_logic_0 = Ch1LgAddCoef_1_ack_in))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    EnableAcquisition <= EnableAcquisition_1_data_reg;

    EnableAcquisition_1_ack_in_assign_proc : process(EnableAcquisition_1_vld_reg)
    begin
        if (((ap_const_logic_0 = EnableAcquisition_1_vld_reg) or ((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = EnableAcquisition_1_vld_reg)))) then 
            EnableAcquisition_1_ack_in <= ap_const_logic_1;
        else 
            EnableAcquisition_1_ack_in <= ap_const_logic_0;
        end if; 
    end process;


    EnableAcquisition_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            EnableAcquisition_1_vld_in <= ap_const_logic_1;
        else 
            EnableAcquisition_1_vld_in <= ap_const_logic_0;
        end if; 
    end process;

    Reset <= Reset_1_data_reg;

    Reset_1_ack_in_assign_proc : process(Reset_1_vld_reg)
    begin
        if (((ap_const_logic_0 = Reset_1_vld_reg) or ((ap_const_logic_1 = ap_const_logic_1) and (ap_const_logic_1 = Reset_1_vld_reg)))) then 
            Reset_1_ack_in <= ap_const_logic_1;
        else 
            Reset_1_ack_in <= ap_const_logic_0;
        end if; 
    end process;


    Reset_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            Reset_1_vld_in <= ap_const_logic_1;
        else 
            Reset_1_vld_in <= ap_const_logic_0;
        end if; 
    end process;
    ...
    trunc_ln674_fu_332_p1 <= ConfigAxil(1 - 1 downto 0);
end behav;
