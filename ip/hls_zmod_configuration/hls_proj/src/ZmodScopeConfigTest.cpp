...
int main() {
	...
	ap_uint<1> Ch1Gain, Ch2Gain, Ch1Coupling, Ch2Coupling;
	...
	if(relayAxil.range(0, 0) != Ch1Gain) {
		printf("Ch1Gain mismatch\n");
		failed = 1;
	}
	if(relayAxil.range(1, 1) != Ch2Gain) {
		printf("Ch2Gain mismatch\n");
		failed = 1;
	}
	if(relayAxil.range(2, 2) != Ch1Coupling) {
		printf("Ch1Coupling mismatch\n");
		failed = 1;
	}
	if(relayAxil.range(3, 3) != Ch2Coupling) {
